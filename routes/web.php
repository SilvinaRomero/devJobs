...
// Route::get('/vacante/{vacante}/create', [VacanteController::class,'edit'])->middleware(['auth', 'verified'])->name('vacantes.edit');
...
Route::get('/vacante/create', [VacanteController::class,'create'])->middleware(['auth', 'rol.reclutador'])->name('vacantes.create');
Route::get('/vacante/{vacante}/edit', [VacanteController::class,'edit'])->middleware(['auth', 'rol.reclutador'])->name('vacantes.edit');
Route::get('/vacante/{vacante}', [VacanteController::class,'show'])->name('vacantes.show');

// Candidatos
Route::get('/candidatos/{vacante}', [CandidatoController::class,'index'])->middleware(['auth', 'rol.reclutador'])->name('candidatos.index');
