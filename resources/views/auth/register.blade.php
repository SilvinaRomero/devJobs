<x-guest-layout>
    <form method="POST" action="{{ route('register') }}" novalidate>
        ...
        <div class="mt-4">
            ...
            <select name="rol" id="rol" class="border-gray-300 focus:border-green-500 focus:ring-green-500 rounded-md shadow-sm w-full">
                <option value="" class="text-gray-200">-- Selecciona un rol --</option>
