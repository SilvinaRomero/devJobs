    ...
    <div class="max-w-7xl mx-auto">
        <form wire:submit.prevent='leerDatosFormulario'>
            <div class="md:grid md:grid-cols-3 gap-5">
                <div class="mb-5">
                    ...
                    <input 
                        ...
                        class="rounded-md shadow-sm border-gray-300 focus:border-green-300 focus:ring focus:ring-green-200 focus:ring-opacity-50 w-full"
                        wire:model="termino"
                    />
                </div>
            ...
            <div class="flex justify-end">
                <input 
                    type="submit"
                    class="bg-green-100 hover:bg-green-300 border border-green-200 transition-colors text-green-700 text-sm font-bold px-10 py-2 rounded-full cursor-pointer uppercase w-full md:w-auto"
                    value="Buscar"
                />
            </div>
        </form>
